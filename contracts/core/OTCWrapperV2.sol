...
contract OTCWrapperV2 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, ERC2771ContextUpgradeable {
    ...
    ///@notice address of strike asset used when minting oTokens
    ...
    function initialize(
        ...
        require(_strikeAsset != address(0), "OTCWrapper: strike asset address cannot be 0");
    ...
    /**
     * @notice sets the strike asset
     * @dev can only be called by owner
     * @param _strikeAsset strike asset address
     */
    function setStrikeAsset(address _strikeAsset) external onlyOwner {
        require(_strikeAsset != address(0), "OTCWrapper: strike asset address cannot be 0");
