...
async function main() {
	...
	const usdc = await ethers.getContractAt("MockERC20", "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913")
	const weth = await ethers.getContractAt("MockERC20", "0x4200000000000000000000000000000000000006")
